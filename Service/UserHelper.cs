...
namespace Service
{
    public class UserHelper
    {
        public static int FindUserId(HospitalContext _context, ClaimsPrincipal User)
        {
            ...
            int doctorId = _context.Doctors.FirstOrDefault(u => u.UserName == doctorEmail).Id;
            return doctorId;
        }
        public static string FindUserRole(ClaimsPrincipal User)
        {
            ...
            string userRole = _context.Doctors.FirstOrDefault(u => u.UserName == userEmail).Specialitys.Name;
            return userRole;
        }
